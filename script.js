...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupHeroSlider() {
        ...
        function showSlide(index) {
            ...
            // Trigger animation for text overlay if it's the second or third slide
            if (index === 1 || index === 2) {
                const textOverlay = slides[index].querySelector('.hero-text-overlay');
                if (textOverlay) {
                    setTimeout(() => {
...
// setInterval(createPetals, 2000); // Removed
